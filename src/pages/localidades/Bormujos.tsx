    ...
    <>
      ...
      <main className="p-6 max-w-4xl mx-auto space-y-8">
        <section className="text-center">
          <h1 className="text-3xl font-bold">Servicios en Bormujos</h1>
          <p className="mt-2 text-lg">
            En Bormujos ofrecemos <strong>servicios de portería</strong>, <strong>mantenimiento integral</strong> y
        ...
        <section className="grid md:grid-cols-3 gap-4">
          ...
          <img src="/imagenes/mantenimiento.jpg" alt="Mantenimiento en Bormujos" className="rounded-xl shadow" />
          <img src="/imagenes/jardineria4.jpg" alt="Jardinería en Bormujos" className="rounded-xl shadow" />
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Porteros y Auxiliares de Control</h2>
          <p>
            Disponemos de <strong>porteros para comunidades en Bormujos</strong>,
          ...
          <p>
            <strong>Diseño y mantenimiento de jardines en Bormujos</strong>,
        ...
        <section>
          <h2 className="text-xl font-semibold mt-8">Ventajas de trabajar con nosotros en Bormujos</h2>
