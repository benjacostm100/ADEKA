...
export default function CoriaDelRio() {
  return (
    <>
      <Navbar />
      <main className="p-6 max-w-4xl mx-auto space-y-8">
        <section className="text-center">
          <h1 className="text-3xl font-bold">Servicios en Coria del Río</h1>
          <p className="mt-2 text-lg">
            En Coria del Río ofrecemos <strong>servicios de portería</strong>, <strong>mantenimiento integral</strong> y
        ...
        <section className="grid md:grid-cols-3 gap-4">
          <img src="/imagenes/security4.jpg" alt="Seguridad en accesos" className="rounded-xl shadow" />
          <img src="/imagenes/mantenimiento.jpg" alt="Mantenimiento en Coria del Río" className="rounded-xl shadow" />
          <img src="/imagenes/jardineria4.jpg" alt="Jardinería en Coria del Río" className="rounded-xl shadow" />
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Porteros y Auxiliares de Control</h2>
          <p>
            Disponemos de <strong>porteros para comunidades en Coria del Río</strong>,
          ...
          <p>
            <strong>Diseño y mantenimiento de jardines en Coria del Río</strong>,
        ...
        <section>
          <h2 className="text-xl font-semibold mt-8">Ventajas de trabajar con nosotros en Coria del Río</h2>
